...
const INITIAL_EMPLOYEES = [
  ...
  { id: 'EMP-108', name: 'Sarah Jenkins', email: 's.jenkins@enterprise.corp', department: 'Product Design', designation: 'Senior UI/UX Designer', manager: 'David Miller', status: 'Active', salary: 98000, shift: 'General Shift (09:00 - 18:00)', holidayCalendar: 'Regional Calendar A', joiningDate: '2023-05-12', location: 'San Francisco Hub', phone: '+1 (555) 017-3819' },
  ...
  { id: 'EMP-102', name: 'Jonathan Carter', email: 'j.carter@enterprise.corp', department: 'Engineering Division', designation: 'Senior Devops Engineer', manager: 'David Miller', status: 'Active', salary: 125000, shift: 'General Shift (09:00 - 18:00)', holidayCalendar: 'National Calendar', joiningDate: '2022-06-15', location: 'Austin Office', phone: '+1 (555) 012-7492' },
  { id: 'EMP-103', name: 'Emily Watson', email: 'e.watson@enterprise.corp', department: 'Product Design', designation: 'Interaction Designer', manager: 'Sarah Jenkins', status: 'Active', salary: 82000, shift: 'General Shift (09:00 - 18:00)', holidayCalendar: 'Regional Calendar A', joiningDate: '2024-02-10', location: 'Remote', phone: '+1 (555) 011-8402' },
  { id: 'EMP-104', name: 'Michael Novak', email: 'm.novak@enterprise.corp', department: 'Marketing', designation: 'Growth Director', manager: 'Alexander Wright', status: 'Active', salary: 110000, shift: 'General Shift (09:00 - 18:00)', holidayCalendar: 'National Calendar', joiningDate: '2023-01-22', location: 'New York HQ', phone: '+1 (555) 013-6492' },
  { id: 'EMP-105', name: 'Jessica Patel', email: 'j.patel@enterprise.corp', department: 'Sales Division', designation: 'Account Executive', manager: 'Michael Novak', status: 'Active', salary: 85000, shift: 'General Shift (09:00 - 18:00)', holidayCalendar: 'National Calendar', joiningDate: '2023-09-01', location: 'Chicago Hub', phone: '+1 (555) 015-8492' },
...
const INITIAL_ATTENDANCE = [
  { id: 'ATT-101', empId: 'EMP-108', date: '2026-07-30', checkIn: '08:52 AM', checkOut: '06:05 PM', workingHours: '9.2 hrs', status: 'Present', late: false },
  ...
  { id: 'ATT-104', empId: 'EMP-102', date: '2026-07-30', checkIn: '09:02 AM', checkOut: '06:00 PM', workingHours: '9.0 hrs', status: 'Present', late: false },
  { id: 'ATT-105', empId: 'EMP-103', date: '2026-07-30', checkIn: '--', checkOut: '--', workingHours: '0.0 hrs', status: 'Absent', late: false },
  { id: 'ATT-106', empId: 'EMP-105', date: '2026-07-30', checkIn: '08:45 AM', checkOut: '06:00 PM', workingHours: '9.2 hrs', status: 'Present', late: false },
  ...
  // Previous days
  { id: 'ATT-201', empId: 'EMP-108', date: '2026-07-29', checkIn: '08:55 AM', checkOut: '06:02 PM', workingHours: '9.1 hrs', status: 'Present', late: false },
...
const INITIAL_LEAVES = [
  { id: 'LV-101', empId: 'EMP-108', empName: 'Sarah Jenkins', type: 'Annual Leave', startDate: '2026-08-15', endDate: '2026-08-18', reason: 'Family vacation trip', status: 'Approved', comments: 'Have a great trip!' },
  { id: 'LV-102', empId: 'EMP-103', empName: 'Emily Watson', type: 'Sick Leave', startDate: '2026-07-31', endDate: '2026-08-01', reason: 'High fever and flu', status: 'Pending', comments: '' },
  { id: 'LV-103', empId: 'EMP-102', empName: 'Jonathan Carter', type: 'Casual Leave', startDate: '2026-07-20', endDate: '2026-07-21', reason: 'Personal work at hometown', status: 'Approved', comments: 'Approved by DM' },
  { id: 'LV-104', empId: 'EMP-105', empName: 'Jessica Patel', type: 'Maternity Leave', startDate: '2026-09-01', endDate: '2026-11-30', reason: 'Maternity period', status: 'Pending', comments: '' },
];

const INITIAL_OT = [
  { id: 'OT-101', empId: 'EMP-108', empName: 'Sarah Jenkins', date: '2026-07-28', hours: 3.5, reason: 'Q3 UI design sprint delivery', status: 'Approved', approvedBy: 'David Miller' },
  { id: 'OT-102', empId: 'EMP-102', empName: 'Jonathan Carter', date: '2026-07-29', hours: 4.0, reason: 'Production server migration patch', status: 'Pending', approvedBy: '' },
  { id: 'OT-103', empId: 'EMP-902', empName: 'Marcus Chen', date: '2026-07-30', hours: 2.0, reason: 'Double shift support coverage', status: 'Approved', approvedBy: 'Rebecca Vance' }
];
...
const INITIAL_SHIFTS = [
  ...
  { empId: 'EMP-108', empName: 'Sarah Jenkins', monday: 'GS', tuesday: 'GS', wednesday: 'GS', thursday: 'GS', friday: 'GS', saturday: 'OFF', sunday: 'OFF' },
  { empId: 'EMP-902', empName: 'Marcus Chen', monday: 'MS', tuesday: 'MS', wednesday: 'MS', thursday: 'MS', friday: 'MS', saturday: 'OFF', sunday: 'OFF' },
  { empId: 'EMP-102', empName: 'Jonathan Carter', monday: 'GS', tuesday: 'GS', wednesday: 'GS', thursday: 'GS', friday: 'GS', saturday: 'OFF', sunday: 'OFF' },
  { empId: 'EMP-103', empName: 'Emily Watson', monday: 'GS', tuesday: 'GS', wednesday: 'GS', thursday: 'GS', friday: 'GS', saturday: 'OFF', sunday: 'OFF' },
  { empId: 'EMP-104', empName: 'Michael Novak', monday: 'GS', tuesday: 'GS', wednesday: 'GS', thursday: 'GS', friday: 'GS', saturday: 'OFF', sunday: 'OFF' },
  { empId: 'EMP-105', empName: 'Jessica Patel', monday: 'GS', tuesday: 'GS', wednesday: 'GS', thursday: 'GS', friday: 'GS', saturday: 'OFF', sunday: 'OFF' },
...
const SHIFT_SWAPS = [
  { id: 'SS-101', empId: 'EMP-108', empName: 'Sarah Jenkins', shiftDate: '2026-08-04', currentShift: 'General Shift', targetShift: 'Morning Shift', requestWith: 'Marcus Chen', status: 'Pending' }
];
...
export const HRMSProvider = ({ children }) => {
  ...
  const applyOvertime = (date, hours, reason) => {
    ...
    addNotification(
      'OT Approval Pending',
      `${user.name} requested ${hours} hrs OT for ${date}.`,
      'pending',
      'Manager'
    );
  };
  ...
  const updateOTStatus = (id, newStatus) => {
    ...
    setOvertime(prev => prev.map(ot => {
      if (ot.id === id) {
        affectedOT = ot;
        return { ...ot, status: newStatus, approvedBy: user.name };
      }
      return ot;
    }));
    ...
    if (affectedOT) {
      addNotification(
        `Overtime ${newStatus}`,
        `Overtime request of ${affectedOT.hours} hrs for ${affectedOT.date} is ${newStatus.toLowerCase()}.`,
        newStatus === 'Approved' ? 'info' : 'warning'
      );

      // If approved, notify Security role so they know the employee is approved to work early/late
      if (newStatus === 'Approved') {
        addNotification(
  ...
  const addHoliday = (newHoliday) => {
    ...
    addNotification(
      ...
      `Holiday '${newHoliday.name}' on ${newHoliday.date} added.`,
      'info',
      'HR'
    );
  };

  const requestShiftSwap = (shiftDate, currentShift, targetShift, swapWithEmployee) => {
    if (!user) return;
    const newSwap = {
      id: `SS-${Date.now()}`,
      empId: user.employeeId,
    ...
    addNotification('Shift Swap Action Required', `${user.name} requests a shift swap on ${shiftDate}.`, 'pending', 'Manager');
  };

  const updateShiftSwapStatus = (id, newStatus) => {
    setShiftSwaps(prev => prev.map(swap => swap.id === id ? { ...swap, status: newStatus } : swap));
    addNotification(`Shift Swap ${newStatus}`, `Shift swap request status changed to ${newStatus}.`, 'info');
  };
